...
<nav id="navbar" class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ url('/') }}">
            ...
            <img class="image" src="../img/sharing.png" width="42px" style="margin: 1px;padding: 0px">
             Flood Information
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <form action="{{ route('search.post') }}" class="d-flex">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a href="{{ route('post.create') }}" class="dropdown-item">Create new post</a>
